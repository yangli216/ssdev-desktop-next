...
pub enum ArtifactSummary {
    ...
    MigrationAuditEvidence {
        ...
        insecure_http_origins: u32,
        authorized_insecure_http_origins: u32,
    ...
    WindowsPackageEvidence {
        ...
        previous_app_version: Option<String>,
        previous_release_metadata_sha256: Option<String>,
        previous_artifact_manifest_sha256: Option<String>,
        plugin_trust_store_sha256: String,
        origin_policy_sha256: String,
        x86_host_sha256: String,
        x64_host_sha256: String,
        deployment_check_sha256: Option<String>,
        deployment_check_generated_at_unix_ms: Option<u64>,
        ...
        ArtifactKind::CutoverPolicy => {
            ...
            (
                ...
                ArtifactSummary::CutoverPolicy {
                    ...
                    maximum_cutover_decision_age_seconds: policy
                        .maximum_cutover_decision_age_seconds,
        ...
        ArtifactKind::MigrationAuditEvidence => {
            ...
            (
                ...
                ArtifactSummary::MigrationAuditEvidence {
                    ...
                    insecure_http_origins: evidence.insecure_http_origin_count,
                    authorized_insecure_http_origins: evidence
        ...
        ArtifactKind::WindowsPackageEvidence => {
            ...
            (
                ...
                ArtifactSummary::WindowsPackageEvidence {
                    ...
                    previous_app_version: evidence.previous_app_version,
                    previous_release_metadata_sha256: evidence.previous_release_metadata_sha256,
                    previous_artifact_manifest_sha256: evidence.previous_artifact_manifest_sha256,
                    ...
                    deployment_check_sha256: evidence.deployment_check_sha256,
                    deployment_check_generated_at_unix_ms: evidence
                        .deployment_check_generated_at_unix_ms,
    ...
    fn documents(root: &Path) -> Vec<(ArtifactKind, PathBuf)> {
        ...
        let values = [
            ...
            (
                ArtifactKind::MigrationAuditEvidence,
                serde_json::json!({
                    "schemaVersion": ssdev_cutover_evidence::EVIDENCE_SCHEMA_VERSION,
                    ...
                    "insecureHttpOriginCount": 1,
                    "authorizedInsecureHttpOriginCount": 1,
            ...
            (
                ...
                serde_json::json!({
                    ...
                    "x86HostSha256": "44".repeat(32),
                    "x64HostSha256": "55".repeat(32),
                    "deploymentCheckSha256": "66".repeat(32),
                    "deploymentCheckGeneratedAtUnixMs": NOW * 1_000,
                    "appVersion": "1.2.3",
            ...
            (
                ...
                serde_json::json!({
                    ...
                    "maximumCutoverDecisionAgeSeconds": 86400,
